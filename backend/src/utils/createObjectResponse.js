...
export async function createObjectResponse(Company, Ticket, Contact) {
    try {
        ...
        const results = {
            ...
            configCancelPass: includes(Ticket.configuracoes__quicksaipos_, "Senha para cancelamento"),
            configCancelReason: includes(Ticket.configuracoes__quicksaipos_, "Motivo para cancelamento"),
            ...
            storeDataPhone: Contact.phone.replace(/\D/g, '').slice(-11),
        };
